...
export default function KetchupHero() {
  ...
  return (
    <div className="relative overflow-hidden bg-[#FFF9F5]">
      {/* Background Decorative Gradient - Soft Tomato Glow */}
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-red-100/60 rounded-full blur-[120px] -z-10" />

      <section className="max-w-7xl mx-auto px-6 lg:px-12 py-12 lg:py-24 flex flex-col lg:flex-row gap-12 lg:items-center">
        {/* LEFT CONTENT */}
        <motion.div
        ...
        >
          ...
          <h1 className="text-6xl md:text-7xl lg:text-8xl font-black text-slate-900 leading-[0.9] tracking-tighter">
            The Boldest <br />
            <span className="text-red-600">Flavor in</span> <br />
            The Bottle.
          </h1>
          ...
          <p className="mt-8 text-lg text-slate-600 max-w-xl mx-auto lg:mx-0 leading-relaxed font-medium">
            ...
            compromise. Elevate your fries, burgers, and backyard BBQs with the
            world’s most requested condiment.
          </p>
        ...
        >
          ...
          <div className="relative aspect-square lg:h-[600px] w-full rounded-[4rem] overflow-hidden shadow-[0_32px_64px_-16px_rgba(220,38,38,0.25)] border-[16px] border-white bg-red-50">
            <Image
              src="/ketchup.jpg" // Replace with your ketchup bottle/food image
              alt="Delicious Ketchup Pour"
              fill
          ...
          {/* Floating Performance Badge - "The Squeeze Factor" */}
          <motion.div
            animate={{ y: [0, -15, 0] }}
            transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
            className="absolute -bottom-6 -left-4 md:left-8 bg-white p-5 rounded-[2.5rem] shadow-2xl flex items-center gap-4 border border-red-50"
          >
